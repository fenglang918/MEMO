...
- PRISM ingest prompt (copy into any AI): `.agents/skills/prism/SKILL.md`
- Core skill (end-to-end CRM maintenance): `.agents/skills/me-network-crm/SKILL.md`
...
2) Ask the agent to follow: `.agents/skills/prism/SKILL.md` (Facts/Inferences/Actions/Me-Info)
3) Write objects:
