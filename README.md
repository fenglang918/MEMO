...
**MEMO** 与小米 **MiMo** 大模型有 75% 的字母重合，发音也几乎一致。

我们正在筹备一个网页 Demo，让没有本地 Agent 环境的用户也能一键体验 MEMO。如果小米 MiMo 团队愿意看在谐音兄弟的份上，给我们一些 API 赞助——我们一定在 README 里把你们写成「MEMO 御用模型」🙏

> *Dear Xiaomi MiMo team,*
> *We share 75% of our letters and 100% of our vibe.*
> *Sponsor our demo, and we'll call you the "Official Engine of MEMO".*
