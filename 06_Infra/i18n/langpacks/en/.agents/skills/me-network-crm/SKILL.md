...
- PRISM (portable ingest skill): `.agents/skills/prism/SKILL.md`
- External source ingest notes (this skill): `.agents/skills/me-network-crm/references/external-source-ingest.md`
- Fields/tags reference (this skill): `.agents/skills/me-network-crm/references/fields-and-tags.md`
...
- Skill-local copy: `python3 .agents/skills/me-network-crm/scripts/validate_people.py`
